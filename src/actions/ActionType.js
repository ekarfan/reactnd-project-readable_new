...
export const STOP_EDITING_COMMENTS = 'comment/STOP_EDITING';
...
export const RETRIEVE_FROM_CATEGORY = 'post/RETRIEVE_FROM_CATEGORY';
export const RETRIEVE_COMMENTS_COUNT = 'post/RETRIEVE_COMMENTS_COUNT';
export const ADD = 'post/ADD';
export const SORT_BY = 'post/SORT_BY';
export const DELETE = 'post/DELETE';
export const START_EDITING = 'post/START_EDITING';
